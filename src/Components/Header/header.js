  ...
  useEffect(() => {
    async function fetchTours() {
      try {
        ...
        const gitSectorsWorld = internationalTours.map(
          (item) => item.SectorName
        );
        const uniqueGitSectorsWorld = [...new Set(gitSectorsWorld)].sort(
        ...
        const uniqueFitSectorsWorld = [...new Set(fitSectorsWorld)].sort(
          (a, b) => a.localeCompare(b)
        );
        ...
        const uniqueGitSectorsIndia = [...new Set(gitSectorsIndia)].sort(
          (a, b) => a.localeCompare(b)
        );
        ...
        const fitSectorsIndia = customizedIndiaTours.map(
          (item) => item.SectorName
        );
        const uniqueFitSectorsIndia = [...new Set(fitSectorsIndia)].sort(
          (a, b) => a.localeCompare(b)
        );
      ...
      <nav className={`header-nav-search ${menuOpen ? "show" : ""}`}>
        <ul className="nav-links">
          ...
          <li className="nav-item dropdown">
            ...
            <ul
              className={`dropdown-menu-customized ${
            ...
            >
              ...
              <div className="tour-type-list">
                <div
                  className={`tour-type-item ${
                    activeTourTab === "world" ? "active" : ""
                  }`}
                  onClick={(e) => {
                    e.stopPropagation();
